...
#
# OPEN QUESTION (not changed, needs your decision)
#   fault_log_rd_data is constrained as a top-level INPUT, and
#   fault_log_wr_en / fault_log_addr / fault_log_data as OUTPUTS. That
#   describes an EXTERNAL fault-log memory. But fault_logger_sram_32kb now
#   contains an INTERNAL SRAM (2 x OpenRAM 512x32). Either this is a second,
#   separate external log interface, or one of the two is vestigial.
#   Verify against ivcu_ev_v3_hybrid_top.sv before trusting these constraints.
# =============================================================================
...
# NOTE: fault_log_rd_data is grouped here -- see OPEN QUESTION in the header.
